@extends('layouts.app')
@section('title', 'Edit User — HRMS')

@section('content')
<h1 class="h4 fw-bold mb-3">Edit User</h1>
<div class="card border-0 shadow-sm" style="max-width:560px">
    <div class="card-body">
        <form method="POST" action="{{ route('operations.update', $user) }}">
            @csrf @method('PUT')
            <div class="mb-3">
            ...
            <div class="d-flex gap-2">
                <button class="btn hrms-btn-primary text-white">Save</button>
