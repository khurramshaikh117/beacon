@extends('layouts.app')
@section('title', 'Edit Device — ZAVI')
...
<div class="mb-4">
    ...
    <h1 class="h3 fw-bold mt-2 mb-0">Edit Device</h1>
</div>
    ...
    <div class="card-body p-4">
        ...
        <form action="{{ route('devices.update', $device->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="label" value="{{ old('label', $device->label) }}"
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="text" name="uuid" id="uuid" value="{{ old('uuid', $device->uuid) }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="zone" value="{{ old('zone', $device->zone) }}"
            ...
            {{-- RSSI Threshold --}}
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" name="rssi" value="{{ old('rssi', $device->rssi) }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="wifi_username" value="{{ old('wifi_username', $device->wifi_username) }}"
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-dark px-4">Update Device</button>
